...
const STATIC_ASSETS = [
  ...
  "./assets/thumbs/pmp-pmo-pt.png",
  "./assets/thumbs/pcm-eam-cmms-pt.png",
  "./assets/thumbs/bpm-cbok-pt.png",
  "./assets/thumbs/lean-six-sigma-pt.jpg",
  "./assets/thumbs/sst-sgg-pt.png",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
